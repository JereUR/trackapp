...
interface Props {
  dataShipment: PropsAddCustomShipment
  setDataShipment: Dispatch<SetStateAction<PropsAddCustomShipment>>
  dataDeliveryPoint: PropsAddDeliveryPoint
  setDataDeliveryPoint: Dispatch<SetStateAction<PropsAddDeliveryPoint>>
  mapRef: React.RefObject<any>
}

const CustomDeliveryPointsForm: React.FC<Props> = ({
  dataShipment,
  setDataShipment,
  dataDeliveryPoint,
...
export default CustomDeliveryPointsForm
